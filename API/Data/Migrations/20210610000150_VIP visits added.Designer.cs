...
namespace API.Data.Migrations
{
    ...
    [Migration("20210610000150_VIP visits added")]
    partial class VIPvisitsadded
    {
            ...
            modelBuilder.Entity("API.Entities.UserVisit", b =>
                {
                    ...
                    b.HasKey("VisiterUserId", "VisitedUserId");
            ...
            modelBuilder.Entity("API.Entities.UserVisit", b =>
                {
                    ...
                    b.HasOne("API.Entities.AppUser", "VisiterUser")
                        .WithMany("VisitedUsers")
                        .HasForeignKey("VisiterUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("VisitedUser");

                    b.Navigation("VisiterUser");
                });
